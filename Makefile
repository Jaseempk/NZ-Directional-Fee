...
verify:
	@forge verify-contract --chain-id 84532 --watch --constructor-args `cast abi-encode "constructor(address,address)" "$(POOL_MANAGER)" "$(PRICEFEED_ADDY)"` --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version 0.8.26 0xef788Cf788e2125EB188C0e7a359A3Db9A0334C0 src/NezlobinDirectionalFee.sol:NezlobinDirectionalFee
